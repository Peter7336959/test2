...
output: 
  html_document:
    ...
    lib_dir: libs
    theme: united
    #theme: !expr sample(c("yeti", "united", "lumen",
    #"cerulean", "cosmo", "flatly", "journal", #"paper","readable", "spacelab"), 1)
    highlight: tango
---
...
> **0729** 提供[案例演練分析參考表格](演練案分析格式.docx)，可先下載自行分析，以利小組討論。
...
(**報名39人**，甄選39人) **地點：職安署北區職業安全衛生中心(新北市新莊區中平路439號 - 北棟10樓1015會議室)**
