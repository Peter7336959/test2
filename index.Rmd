...
> <span style="color: red;"> 0805 **南區(0805週二)已順利辦理完成，感謝大家參與。(詳見下方南區完成公告)**</span>
...
> **敬請各組將演練完成檔案，於0811(週一)寄出(尊重您的分享意願)，檔案名稱為"南區第 _ 組"。**

> <span style="color: red;">**感謝南區第6組分享演練成果**</span> (著實不易，內容無關對錯，實做便有收穫，謝謝分享)

> <span style="color: red;">  **已於 三、演練職災事故個案(實例)區，提供分析參考，供分組學員參閱一週。**</span>
...
-   學員分組演練產出，**將擇優與遵從各組意願放置此網頁**，分析參考欄位中。
