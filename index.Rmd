...
> 0822 <span style="color: darkgreen;">**中區研討會(0821週四)已順利辦理完成，感謝大家參與，及中市勞檢處大力協助。**</span> 

> 0822 敬請 <span style="color: red;"> **中區**各組</span>將演練完成檔案，於<span style="color: red;">0828(週四)</span>寄出(尊重您的分享意願)，檔案名稱為”中區第_組”。<span style="color: darkgreen;">(參考分析已公布)</span> 

- 0815 南區分享演練案例，感謝<span style="color: red;">第 2，3，4，5，6，9，10組初步成果分享。</span>(詳見下方南區完成公告)**
- 0815 新增 後見之明、因果、歸因、確認偏誤 - 事故調查時常見心理認知謬誤 (詳見[第五節](#五))
- 0805：[宣導會講義 pdf]() 
- 0803：分析工具解析資訊圖表 ([infographic](tools\info.html))
- 0731：演練個案可使用自己公司案例 (案例可調整)。
- 0730：工作坊即將開始，仍有學員未填前測問卷，請填寫[前測問卷表單]()
- 0729：提供**[案例演練分析參考表格](演練案分析格式.docx)**，可先參考分析方法圖卡自行分析，以利小組討論。
