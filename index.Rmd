...
> 0805 **南區(0805週二)已順利辦理完成，感謝大家參與。(詳見下方南區完成公告)**
...
> **敬請各組將演練完成檔案，於0811(週一)前上傳雲端網址分享(尊重您的分享意願)，檔案名稱為"南區第 _ 組"。[上傳檔案雲端網址](https://drive.google.com/drive/folders/1qNmMeDNzjll6HV5s_ax4_kbnzXCXeYcF?usp=sharing)**


> **另也於 三、演練職災事故個案(實例)區，提供分析參考，供分組學員參閱一週。**
