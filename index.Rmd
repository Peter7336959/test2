...
> 0811 **新增南區分享演練案例，感謝<span style="color: red;">第4，5，6，10組。</span>(詳見下方南區完成公告)**

- 0810 新增 **事故調查時常見心理認知謬誤** (詳見[第五節](#五))
-  0805 **新增 - [宣導會講義 pdf](tools\職災事故調查制度實務指南教材參考 v1.pdf)  **
- 0803 **新增 - 分析工具解析資訊圖表 [infographic](tools\info.html)) **
- 0731：演練個案可使用自己公司案例 (案例可調整)。
- 0730：工作坊即將開始，仍有學員未填前測問卷，請填寫 [前測問卷表單](https://forms.gle/SLkZx5UksNa8v5p28)
...
> 0808 <span style="color: red;">**感謝南區第4，5，6及10組完整分享演練成果(詳見[第三節](#三))**</span> 

- 0805 **敬請各組將演練完成檔案，於0811(週一)寄出(尊重您的分享意願)，檔案名稱為"南區第 _ 組"。**
- 0805 **已於 三、演練職災事故個案(實例)區，提供分析參考，供分組學員參閱一週。**
打鐵趁熱，趁勝追擊 Strike While the Iron Is Hot....
...
(**報名92人**，甄選45人) **地點：台中市勞動檢查處(台中市豐原區陽明街36號)**
...
宣導會名單 %>% filter(確認場次=="中區8月21日" & 亂數抽籤=="y") %>% select(-2) %>%
  ...
  kable_classic(bootstrap_options = c("striped", "hover"), 
    ...
    pack_rows("第8組", 31, 35,label_row_css = "background-color: #666; color: #fff;") %>%
    pack_rows("第9組", 36, 40,label_row_css = "background-color: #666; color: #fff;") %>%
    pack_rows("第10組",41, 45,label_row_css = "background-color: #666; color: #fff;") %>%
footnote(general = "按報名順序暫時分組，指定演練案例-可先參見下面案例清單")%>%
...
|  | [倒塌崩塌4](cases/D倒塌崩塌/倒塌案4_演練.pdf) |[倒塌崩塌案4分析參考](cases/D倒塌崩塌/倒塌案4_分析參考.pdf) | 職安署公告 | [原始檔案](cases/D倒塌崩塌/倒塌案4_原始.pdf) |
 |  |南區第4組分享  |[<span style="color: red;">南區第4組分享</span>](cases/D倒塌崩塌/南區第4組演練分享.pdf)  |<span style="color: red;">@南區第4組</span>   | |
...
|  | [感電案3](cases/E感電/感電案3_演練.pdf) |[感電案3分析參考](cases/E感電/感電案3_分析參考.pdf)  | 職安署公告 | [原始檔案](cases/E感電/感電案3_原始.pdf) |
...
|  | [捲夾案4](cases/A切割夾捲/捲夾案4_演練.pdf) |[捲夾案4分析參考](cases/A切割夾捲/夾捲案4分析參考.pdf)   | 職安署公告 |[原始檔案](cases/A切割夾捲/捲夾案4_原始.pdf) |
...
|  | [局限空間案5](cases/C局限空間/局限案例5_演練.pdf) |[局限空間案5分析參考](cases/C局限空間/局限案例5_分析參考.pdf) | 職安署電子書 | [原始檔案](cases/C局限空間/局限案例5_原始.pdf) |
...
|  | [墜落案3](cases/F墜落/墜落案3_演練.pdf) |[墜落案3分析參考](cases/F墜落/墜落案3_分析參考.pdf) | 職安署公告 | [原始檔案](cases/F墜落/墜落案3_原始.pdf) |
