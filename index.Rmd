...
宣導會名單 %>% filter(確認場次=="北區9月18日" & 亂數抽籤=="y") %>% 
  ...
  kable_classic(bootstrap_options = c("striped", "hover"), 
    ...
    pack_rows("第5組", 17, 21,label_row_css = "background-color: #666; color: #fff;") %>%
    pack_rows("第6組", 22, 25,label_row_css = "background-color: #666; color: #fff;") %>%
    ...
    pack_rows("第10組", 39, 42,label_row_css = "background-color: #666; color: #fff;") %>%
